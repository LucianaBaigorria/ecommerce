...
function displayProducts() {
    ...
    const cabello = productList.filter((p) => p.category === "cabello");
    displayProductsByType(cabello, "product-cards-cabello");
  
    const corporal = productList.filter((p) => p.category === "corporal");
    displayProductsByType(corporal, "product-cards-corporal");
  
    const facial = productList.filter((p) => p.category === "facial");
    displayProductsByType(facial, "product-cards-facial");
}
